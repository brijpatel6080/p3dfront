    ...
    <div className="sidebar__content">
      ...
      <ul className="sidebar__block">
        ...
        <SidebarCategory title="Doctors" icon="users" sidebarCollapse={sidebarCollapse}>
          ...
          {/* <SidebarLink title="View Doctor" route="/ViewDoctors" /> */}
        </SidebarCategory>
        ...
        <SidebarCategory title="Specialities" icon="file-add" sidebarCollapse={sidebarCollapse}>
          <SidebarLink title="View" route="/SpecialitiesList" />
          <SidebarLink title="Add" route="/AddSpecialities" />
        </SidebarCategory>
        <SidebarCategory title="Sub Specialities" icon="file-add" sidebarCollapse={sidebarCollapse}>
          <SidebarLink title="View" route="/SubSpecialitiesList" />
          <SidebarLink title="Add" route="/AddSubSpecialities" />
        </SidebarCategory>
      </ul>
      <ul className="sidebar__block">
