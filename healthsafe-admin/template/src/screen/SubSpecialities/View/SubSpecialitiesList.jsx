...
const SubSpecialitiesList = () => {
  ...
  return (
    <Container className="SubSpecialitiesList">
      <Row>
        <Col md={12}>
          <h3 className="page-title">{t('tables.subspecialities.title')}</h3>
...
export default SubSpecialitiesList
