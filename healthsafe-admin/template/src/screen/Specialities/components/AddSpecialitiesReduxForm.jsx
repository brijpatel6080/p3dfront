...
import { getInterestsList, addSpeciality } from '../../../utils/api/APIServices'
...
const VerticalForm = ({
  ...
  const handleSave = async (values) => {
    ...
    const { response, error } = await addSpeciality(payload, token)
    console.log('addSpeciality response, error', response, error.response)
    // setShowLoader(false)
    if (error) {
...
export default reduxForm({
  form: 'Specialities_form_validation', // a unique identifier for this form
  validate,
})(VerticalForm)
