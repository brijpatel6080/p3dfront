...
import VerticalForm from "../components/AddDoctorReduxForm";
const ModalAddDoctor = ({
  ...
  return (
    <div>
      ...
      <Button color={color} onClick={toggle} className="btnAddDoctor">
        {btn}
      </Button>
      <Modal
        isOpen={modal}
