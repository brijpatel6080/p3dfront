...
//     try{
//       const options = createOptions(token); 
//       const res = await axios.put('/admin/blogs/interests/'+id,payload,options)
//       result.response = res.data
//       resovle(result)
//     }
//     catch(error){
...
//     try{
//       const options = createOptions(token); 
//       const res = await axios.post('/specialties/sub-specialties', payload,options)
//       result.response = res.data
//       resovle(result)
//     }
//     catch(error){
...
//     try{
//       const options = createOptions(token); 
//       const res = await axios.put('/specialties/sub-specialties/'+id, payload, options)
//       result.response = res.data
//       resovle(result)
//     }
//     catch(error){
...
//     try{
//       const options = createOptions(token); 
//       const res = await axios.delete('/specialties/sub-specialties/'+id,options)
//       result.response = res.data
//       resovle(result)
//     }
//     catch(error){
